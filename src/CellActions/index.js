...
export default function CellActions({
  ...
  return (
    <div className="cell-actions-container">
      ...
      <FormatAlignLeft
        className={`cell-actions ${activeCell.alignment === "left" ? "cell-action-selected" : ""
          }`}
        onClick={() => activeCell && activeCell.id && changeAlignment("left")}
      />
      <FormatAlignCenter
        className={`cell-actions ${activeCell.alignment === "center" ? "cell-action-selected" : ""
          }`}
        onClick={() => activeCell && activeCell.id && changeAlignment("center")}
      />
      <FormatAlignRight
        className={`cell-actions ${activeCell.alignment === "right" ? "cell-action-selected" : ""
          }`}
      ...
      <FormatBold
        className={`cell-actions ${activeCell.bold ? "cell-action-selected" : ""
          }`}
        onClick={() => activeCell && activeCell.id && changeBoldProp()}
      />
      <FormatItalic
        className={`cell-actions ${activeCell.italic ? "cell-action-selected" : ""
          }`}
        onClick={() => activeCell && activeCell.id && changeItalicProp()}
      />
      <FormatUnderlined
        className={`cell-actions ${activeCell.underline ? "cell-action-selected" : ""
          }`}
        name="underline"
